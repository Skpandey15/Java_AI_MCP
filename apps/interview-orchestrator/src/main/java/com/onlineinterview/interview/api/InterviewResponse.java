...
public record InterviewResponse(
        ...
        int questionCount, int passingPercentage, String status, Instant createdAt) {
    static InterviewResponse from(InterviewDefinition definition) {
        return new InterviewResponse(definition.getId(), definition.getTitle(),
                ...
                definition.getPassingPercentage(), definition.getStatus().name(), definition.getCreatedAt());
    }
}
