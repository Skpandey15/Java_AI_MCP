...
export const ecosystemTechnologies = {
  ...
  DATA_ENGINEERING: [
    ...
    'Apache Pulsar', 'Redpanda', 'Amazon Kinesis', 'Azure Event Hubs', 'Google Cloud Pub/Sub',
    'NATS and JetStream', 'Redis Streams', 'Apache Beam', 'ksqlDB', 'Kafka Connect', 'Debezium',
    'Apache NiFi', 'Apache Storm', 'Apache Samza', 'Materialize', 'RisingWave', 'Schema Registry',
  ],
  AI_GOVERNANCE: [
  ...
  NODEJS: [
    ...
    'Fastify', 'Koa', 'Prisma', 'TypeORM', 'Sequelize', 'Socket.IO', 'Apollo GraphQL Server',
    'Passport and JWT Auth', 'BullMQ and Job Queues', 'PM2 and Process Management',
    'Serverless Node (AWS Lambda)', 'Testing with Jest and Supertest',
    'Node.js Security', 'Node.js Performance and Profiling', 'Node.js Error Handling and Logging',
  ],
} as const
...
const technologyDescriptions: Record<string, string> = {
  ...
  'Apache Pulsar': 'A distributed pub/sub and event-streaming platform with segmented storage, multi-tenancy, and built-in geo-replication.',
  Redpanda: 'A Kafka API-compatible streaming platform written in C++ with no JVM or ZooKeeper for low, predictable latency.',
  'Amazon Kinesis': 'AWS-managed service for real-time ingestion and processing of streaming data at scale.',
  'Azure Event Hubs': 'Azure-managed big-data event ingestion service with Kafka-protocol compatibility.',
  'Google Cloud Pub/Sub': 'A fully managed, global messaging and event-ingestion service on Google Cloud.',
  'NATS and JetStream': 'A lightweight cloud-native messaging system; JetStream adds persistence, streaming, and replay.',
  'Redis Streams': 'An append-only log data type in Redis providing lightweight event streaming with consumer groups.',
  'Apache Beam': 'A unified programming model for batch and streaming pipelines that runs on multiple execution engines.',
  ksqlDB: 'A streaming SQL engine for building real-time stream-processing applications on top of Kafka.',
  'Kafka Connect': 'A framework for streaming data between Kafka and external systems using reusable source/sink connectors.',
  Debezium: 'An open-source change-data-capture platform that streams database row-level changes as events.',
  'Apache NiFi': 'A visual dataflow tool for routing, transforming, and mediating streaming data between systems.',
  'Apache Storm': 'A distributed real-time computation system for processing unbounded streams with low latency.',
  'Apache Samza': 'A distributed stream-processing framework, built with Kafka, for stateful, fault-tolerant pipelines.',
  Materialize: 'A streaming database that maintains incrementally updated materialized views using standard SQL.',
  RisingWave: 'A Postgres-compatible streaming database for real-time, incrementally maintained SQL queries.',
  'Schema Registry': 'A service that manages and enforces versioned event schemas (Avro/Protobuf/JSON) for producer/consumer compatibility.',
  ...
  'Streams and Buffers': 'Readable/writable/transform streams and Buffers for efficient, backpressure-aware I/O.',
  'Worker Threads and Clustering': 'Scaling CPU-bound work with worker threads and multi-core with the cluster module.',
  'npm and Package Management': 'Dependency management with npm/pnpm/yarn — semver, lockfiles, scripts, and workspaces.',
  Express: 'A minimal, unopinionated Node web framework with middleware-based routing.',
  NestJS: 'An opinionated, TypeScript-first Node framework with dependency injection, modules, and decorators.',
  Fastify: 'A high-performance, low-overhead Node web framework with schema-based validation.',
  Koa: 'A lightweight Node web framework from the Express team built around async middleware.',
  Prisma: 'A type-safe ORM and query builder for Node/TypeScript with migrations and a schema DSL.',
  TypeORM: 'A TypeScript ORM for Node supporting both Active Record and Data Mapper patterns.',
  Sequelize: 'A promise-based Node ORM for SQL databases with models, associations, and migrations.',
  'Socket.IO': 'A library for real-time, bidirectional, event-based communication over WebSockets.',
  'Apollo GraphQL Server': 'A production-ready GraphQL server for Node with schemas, resolvers, and caching.',
  'Passport and JWT Auth': 'Authentication in Node with Passport strategies and JSON Web Tokens.',
  'BullMQ and Job Queues': 'Background jobs and queues in Node backed by Redis, with retries and scheduling.',
  'PM2 and Process Management': 'Running, clustering, and monitoring Node processes in production with PM2.',
  'Serverless Node (AWS Lambda)': 'Building event-driven Node functions on AWS Lambda, with cold-start and packaging concerns.',
  'Testing with Jest and Supertest': 'Unit and HTTP integration testing of Node apps with Jest and Supertest.',
  'Node.js Security': 'Securing Node apps: Helmet, input validation, dependency audits, and OWASP risks.',
  'Node.js Performance and Profiling': 'Profiling event-loop lag, memory, and CPU, and tuning Node for throughput.',
  'Node.js Error Handling and Logging': 'Robust error handling, async stack traces, and structured logging in Node.',
