...
class Settings(BaseSettings):
    ...
    # OpenTelemetry OTLP/HTTP base endpoint (e.g. http://tempo.observability:4318).
    # Empty disables trace export; set it to extend the distributed trace into this service.
